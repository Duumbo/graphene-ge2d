...
raw_data/diagonals.npy: src/graphene_ge2d/struc_bande/_constantes.py src/graphene_ge2d/struc_bande/write_matrix.py src/graphene_ge2d/struc_bande/matrice_coef.py src/graphene_ge2d/struc_bande/coquilles.py
